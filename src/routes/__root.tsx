...
import { CustomCursor } from "@/components/safework/CustomCursor";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "SafeWork — Gestão de Segurança do Trabalho" },
      {
        name: "description",
        content:
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,300..900;1,300..900&family=Fraunces:ital,wght@0,600;1,500;1,600&display=swap",
      },
    ],
  }),
